        ...
        <ul class="flex items-center">
          ...
          <li>
            <a
              ...
              className=""
            >
              <button class="text-white bg-[#0b57d0] rounded-[100px] text-sm font-medium hover:shadow-btn transition-shadow duration-100 ease-out w-21.25 h-10 cursor-pointer ml-1" role="button">
                Sign in
              </button>
            </a>
          </li>
