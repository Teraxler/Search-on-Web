  ...
  return (
    <div className="flex items-center gap-x-4 py-2 border-b border-b-[#eeeeee]">
      <div className="hidden xs:block shrink-0 w-22.5 max-h-22.5 overflow-hidden rounded-xs">
        <a target="_blank" href={link} className="block text-xs max-w-full max-h-full">
          <img
            loading="lazy"
      ...
      <div className="flex-1">
        <h3 className="text-sm font-bold text-[#0D4CDE]">
        ...
        <div className="flex gap-x-1.25 text-xs mt-1">
          ...
          <span className="text-[#7b7b7b]">
            {calcRelativeDateTimeDifference(pubDate)}
          </span>
        </div>
        <p className="text-[12.22px] my-1.5 line-clamp-3">
